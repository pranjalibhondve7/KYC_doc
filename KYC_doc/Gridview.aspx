<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Gridview.aspx.cs" Inherits="KYC_doc.Gridview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" HorizontalAlign="Center" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:Button ID="btnaccept" CssClass="btn btn-primary" runat="server" CommandArgument='<%# Eval("ID") %>' Text="Accept" OnCommand="btnaccept_Command" />
                    <asp:Button ID="btnreject" CssClass="btn btn-danger" runat="server" CommandArgument='<%# Eval("ID") %>' Text="Reject" OnCommand="btnreject_Command" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
